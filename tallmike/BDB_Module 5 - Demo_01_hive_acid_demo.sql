...
--Does not support update bucket column
--UPDATE employee SET emp_id = 7 WHERE dept_name = hr;

UPDATE employee SET dept_name = 'IT' WHERE emp_id = 7;
--Does not support update partition column
--UPDATE employee SET start_date = '20170101' WHERE emp_id = 7;
...
DROP DATABASE acid_demo cascade;